        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <button className="ml-5 hover:bg-blue-700 text-white font-semibold py-2 px-5 rounded-lg transition-colors duration-300 flex items-center gap-2 text-sm" style={{ background: '#1B29CB' }}>
