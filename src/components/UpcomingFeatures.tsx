      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-2 items-center">
            ...
            <div className="grid grid-cols-2 gap-x-0 gap-y-4 upcoming-feature-grid">
              {/* Auto Apply */}
            ...
            <div>
              ...
              <button className="ml-5 hover:bg-blue-700 text-white font-semibold py-2 px-5 md:py-4 md:px-8 rounded-lg transition-colors duration-300 flex items-center gap-2 text-sm md:text-base lg:text-lg" style={{ background: '#1B29CB' }}>
