    ...
    <section className="py-16 px-4">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden">
          ...
          {/* Text overlay */}
          <div className="absolute inset-0 flex items-center mobile-cta-container">
            <div className="flex-1 text-white p-8 md:p-12 mobile-cta-content">
              <h2 className="text-xl sm:text-2xl md:text-4xl font-bold mb-6 leading-tight mobile-cta-title">
                Craft Your Future with a Custom<br />
                Resume & AI Interview Coach
              </h2>
              <button className="mobile-cta-button bg-white text-blue-600 font-semibold px-8 py-3 rounded-lg hover:bg-gray-100 transition-colors duration-200 text-xs sm:text-sm md:text-base">
                SIGNUP FOR FREE
              </button>
            </div>
          </div>
        ...
        <div className="text-center mt-8">
          <div className="flex items-center justify-center gap-4 sm:gap-2 md:gap-4">
            ...
            <span className="snow-text" style={{ color: '#1B29CB' }}>
